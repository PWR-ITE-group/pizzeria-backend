...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userDetailsService); // Указываем, откуда брать юзеров
        authProvider.setPasswordEncoder(passwordEncoder());     // Указываем, чем хешировать
        return authProvider;
    }
